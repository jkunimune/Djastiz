...
love; be in love; be infatuated; \hyperref[amilon]{ʟᴏᴧ} is romantically in love with \hyperref[amilum]{ʟᴜᴍ} \label{ami} \\
...
lover; in love; infatuated \label{amilon} \\
...
watch; wristwatch \label{amhulinoluat} \\
...
list; order; sequence; queue; line; series \label{oltolum} \\
...
1 000 000 000; one billion; billion; giga-; G \label{lyonmes} \\
\textbf{lyoncah} \textit{num.} (\hyperref[lyon]{lyon}+\hyperref[cah]{cah})
1 000 000; one million; million; mega-; M \label{lyoncah} \\
...
1 000; one thousand; thousand; kilo-; k \label{lyonsan} \\
...
10 000; ten thousand \label{lyonfol} \\
...
1 000 000 000 000; one trillion; trillion; terra-; T \label{lyonkantos} \\
...
feces; excrement; poop; manure; guano \label{nalkaskutilon} \\
...
meter; measure; readout; measuring device \label{noluat} \\
...
love; adore; be attached; \hyperref[muccailon]{ʟᴏᴧ} platonically loves ʟᴜᴍ \label{muccai} \\
\textbf{muccailon} \textit{n.} (\hyperref[muccai]{muccai}+\hyperref[lon]{lon})
attached \label{muccailon} \\
...
melody; tune \label{hailyanoltolum} \\
...
three-quarters; three-fourths; 3/4; .75 \label{sanpelfol} \\
...
100; one hundred; hundred; hecto \label{kannulnul} \\
...
all; absolute; maximum; exact; complete \label{kit} \\
...
meterstick; ruler; measuring tape; stick \label{kulenoluat} \\
...
spectrometer \label{kwanlamanoluat} \\
...
two-thirds; 2/3; .̅6 \label{tospelsan} \\
...
chain; be chained; \hyperref[tokatokalon]{ʟᴏᴧ} is chained together in \hyperref[tokatokalum]{ʟᴜᴍ} \label{tokatoka} \\
\textbf{tokatokalon} \textit{n.} (\hyperref[tokatoka]{tokatoka}+\hyperref[lon]{lon})
link; chained \label{tokatokalon} \\
\textbf{tokatokalum} \textit{n.} (\hyperref[tokatoka]{tokatoka}+\hyperref[lum]{lum})
chain \label{tokatokalum} \\
\textbf{tokatokaki} \textit{v.} (\hyperref[tokatoka]{tokatoka}+\hyperref[ki]{ki})
chain; link; incorporate; chain together; ʟєꜱ chains ʟᴏᴧ together into ʟᴜᴍ \label{tokatokaki} \\
...
half; one half; 1/2; .5 \label{peltos} \\
...
scale; balance \label{palinoluat} \\
...
have affinity; be fond; not mind; \hyperref[pihcailon]{ʟᴏᴧ} has an affinity for ʟᴜᴍ \label{pihcai} \\
\textbf{pihcailon} \textit{n.} (\hyperref[pihcai]{pihcai}+\hyperref[lon]{lon})
fond \label{pihcailon} \\
