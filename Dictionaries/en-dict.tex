...
even; so; too; neither; \textit{emphasises something surprising} \label{ifen} \\
...
memorise; drill; remind; \hyperref[yatapowikiles]{ʟєꜱ} makes ʟᴏᴧ memorise ʟᴜᴍ \label{yatapowiki} \\
\textbf{yatapowikiles} \textit{n.} (\hyperref[yatapowiki]{yatapowiki}+\hyperref[les]{les})
driller; crammer; memoriser \label{yatapowikiles} \\
