...
\textbf{'asutan} \textit{n.} (\arabic{السودان‎} [assuːdaːn])
Sudan \label{'asutan} \\
...
butterfly \label{lonomilukutahutyeh} \\
...
squash; gourd; pumpkin; zucchini; Cucurbita \label{waluh} \\
...
something; someone; one; \textit{indeterminate}; a noun not afformentioned \label{wan} \\
...
boo; fuck; not; \textit{negative exclamative mood} \label{wahau} \\
...
\textbf{nila} \textit{v.} (\devanagari{नीला} [niːlaː])
be blue; be cool; \hyperref[nilalon]{ʟᴏᴧ} reflects short wavelength light \label{nila} \\
\textbf{nilalon} \textit{n.} (\hyperref[nila]{nila}+\hyperref[lon]{lon})
blue; cool \label{nilalon} \\
\textbf{nilalyan} \textit{n.} (\hyperref[nila]{nila}+\hyperref[lyan]{lyan})
blueness \label{nilalyan} \\
\textbf{nilacakalum} \textit{n.} (\hyperref[nila]{nila}+\hyperref[cakalum]{cakalum})
cobalt (substance) \label{nilacakalum} \\
...
\textbf{'sunah} \textit{n.} (\arabic{سنة} [ˈsunnah])
...
\textbf{tatu} \textit{v.} (\bengali{ধাতু} [d̪̤at̪u])
