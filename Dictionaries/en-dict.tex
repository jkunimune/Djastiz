...
\textbf{yek} \textit{n.} (\hyperref[won]{\~{}\~{}won\~{}\~{}})
...
\textbf{lum} \textit{n.} (\hyperref[l]{l}+\hyperref[m]{um})
...
\hyperref{https://xkcd.com/1015/} \label{wawikiles} \\
...
rand; R \label{'wan} \\
\textbf{wan ayf} \textit{n.} (\hyperref[wan ]{wan }+\hyperref[yf]{ayf})
in some event \label{wan ayf} \\
\textbf{'wanatium} \textit{n.} (Lat. ⟨vanadium⟩ [vanadɪʊ̃])
vanadium \label{'wanatium} \\
\textbf{wan ial} \textit{n.} (\hyperref[wan ]{wan }+\hyperref[al]{ial})
for some reason \label{wan ial} \\
\textbf{wan ip} \textit{n.} (\hyperref[wan ]{wan }+\hyperref[p]{ip})
somehow \label{wan ip} \\
\textbf{wan uat} \textit{n.} (\hyperref[wan ]{wan }+\hyperref[at]{uat})
with something; somehow \label{wan uat} \\
\textbf{wan yot} \textit{n.} (\hyperref[wan ]{wan }+\hyperref[ot]{yot})
somewhere \label{wan yot} \\
\textbf{wan wel} \textit{n.} (\hyperref[wan ]{wan }+\hyperref[el]{wel})
...
\hyperref{https://forum.tfes.org/index.php?topic=6098.msg132382\#msg132382}; stupid \label{nopowinyolon} \\
...
\textbf{ni} \textit{v.} (\hyperref[ku]{\~{}\~{}ku\~{}\~{}})
...
\textbf{hyo} \textit{v.} (\hyperref[cwe]{\~{}\~{}cwe\~{}\~{}})
...
\textbf{ce} \textit{v.} (\hyperref[ho]{\~{}\~{}ho\~{}\~{}})
...
\textbf{kit} \textit{num.} (\hyperref[nul]{\~{}\~{}nul\~{}\~{}})
...
\textbf{kula} \textit{v.} (Hin. ⟨खुला⟩ [kʰulaː])
